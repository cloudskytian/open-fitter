"""WeightTransferPreparationStageV2: Phase対応版のウェイト転送準備ステージ

新アーキテクチャでは、このステージはPhase 2でのみ使用される。
is_final_pairチェックを削除し、ベースメッシュが必ず存在することを前提とする。
"""
...
class WeightTransferPreparationStageV2:
    """Phase 2用: ウェイト転送の準備処理を担当するステージ
